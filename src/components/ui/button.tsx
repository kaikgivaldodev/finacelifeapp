...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-gold text-primary-foreground shadow-md hover:shadow-lg hover:shadow-primary/20 active:scale-[0.98]",
        destructive:
        ...
        success:
          "bg-gradient-success text-success-foreground shadow-md hover:shadow-lg active:scale-[0.98]",
        danger:
          "bg-gradient-danger text-destructive-foreground shadow-md hover:shadow-lg active:scale-[0.98]",
        gold:
          "bg-gradient-gold text-primary-foreground shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/30 active:scale-[0.98]",
        muted:
