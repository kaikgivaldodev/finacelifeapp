...
const mockGoals: Goal[] = [
  { id: "1", name: "Limite de gastos mensais", type: "spending", targetAmount: 5000, currentAmount: 4300, isCompleted: false },
  { id: "2", name: "Reserva de emergência", type: "saving", targetAmount: 15000, currentAmount: 9800, deadline: new Date(2025, 5, 1), isCompleted: false },
  { id: "3", name: "Viagem de férias", type: "saving", targetAmount: 5000, currentAmount: 5000, deadline: new Date(2025, 0, 15), isCompleted: true },
  { id: "4", name: "Novo celular", type: "saving", targetAmount: 3000, currentAmount: 1200, deadline: new Date(2025, 2, 1), isCompleted: false },
];
...
export default function Metas() {
  ...
  const spendingGoals = mockGoals.filter(g => g.type === "spending");
  const savingGoals = mockGoals.filter(g => g.type === "saving");
  const completedGoals = mockGoals.filter(g => g.isCompleted);
          ...
          <div className="divide-y divide-border">
            {spendingGoals.length === 0 ? (
              <div className="py-8 text-center text-muted-foreground">
                Nenhuma meta de gasto definida
              </div>
            ) : (
